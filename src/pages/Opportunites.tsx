...
export default function Opportunites(){
 ...
 return <div className="opportunities-page">
  ...
  {!!projects.length&&<details className="rc-launch"><summary>Comparer deux ou trois achats locatifs</summary><RentalComparison projects={projects} demo={demo}/></details>}
